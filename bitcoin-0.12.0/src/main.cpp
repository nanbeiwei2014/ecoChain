...
//********************begin delete by mengqg pause 20161117*********************************************************************
//    EraseOrphansFor(nodeid);
//********************end  delete by mengqg pause 20161117 *********************************************************************
    nPreferredDownload -= state->fPreferredDownload;
...
//*******************end by mengqg pause 20161116************************************************************************************
    ...
    bool fDoFullFlush = (mode == FLUSH_STATE_ALWAYS)  || fPeriodicFlush || fFlushForPrune;//|| fCacheLarge || fCacheCritical;
...
//###########begin delete by mengqg we do not need to upgrade now 20161118##################################################33
...
//        }
//    }
//###########end delete by mengqg we do not need to upgrade now 20161118##################################################3
}
...
bool CVerifyDB::VerifyDB(const CChainParams& chainparams, CBestBlock *coinsview, int nCheckLevel, int nCheckDepth)
{
    LOCK(cs_main);
    ...
    for (CBlockIndex* pindex = chainActive.Tip(); pindex && pindex->pprev; pindex = pindex->pprev)
    {
        ...
        if (nCheckLevel >= 3 && pindex == pindexState && (coins.DynamicMemoryUsage() + pcoinsTip->DynamicMemoryUsage()) <= nCoinCacheUsage) {
            ...
            if (!fClean) {
                ...
                nGoodTransactions += block.qvtx.size();
        }
...
//****************begin modify  by mengqg  20161116 *******************************************************************************************************
    qmempool.clear();
 //   mempool.clear();
//    mapOrphanTransactions.clear();
//    mapOrphanTransactionsByPrev.clear();
//****************end modify  by mengqg  20161116 *******************************************************************************************************
    nSyncStarted = 0;
        ...
        const CInv &inv = *it;
        {
            ...
            else if (inv.IsKnownType())
            {
                ...
                if (!pushed && inv.type == MSG_TX) {
                	Cqkgj_basic_data tx;
                    if (qmempool.lookup(inv.hash, tx)) {
