...
//        pchMessageStart[3] = 0xd9;
        ...
        nDefaultPort = 12333;	//8333;
        nMaxTipAge = 24 * 60 * 60;
        nPruneAfterHeight = 100000;

        //genesis = CreateGenesisBlock(1231006505, 2083236893, 0x1d00ffff, 1, 50 * COIN);
        genesis = CreateGenesisBlock(1480063343, 0x1d00ffff,0x01, 1);
...
std::cout<<"thrid str1's value:"<<GetTime()<<std::endl;
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x5f73bc5a658fe0777c7ce351347a21671b29836cbedde34c1610fbff0c172c17"));
...
//            (295000, uint256S("0x00000000000000004d9b4ef50f0f9d686fd69db2e03af35a100370c64632a983"))
            (0, uint256S("0x5f73bc5a658fe0777c7ce351347a21671b29836cbedde34c1610fbff0c172c17")),
...
public:
    CTestNetParams() {
       ...
       // genesis = CreateGenesisBlock(1296688602, 414098458, 0x1d00ffff, 1, 50 * COIN);
        genesis = CreateGenesisBlock(1296688602,  1);
        consensus.hashGenesisBlock = genesis.GetHash();
